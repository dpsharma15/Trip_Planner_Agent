...
def location_task(agent, from_city, destination_city, date_from, date_to):
    return Task(
        description=f"""
        In English: Provide travel-related information including accommodations, cost of living,
...
def guide_task(agent, destination_city, interests, date_from, date_to):
    return Task(
        description=f"""
        In English : Provide a travel guide with attractions, food recommendations, and events.
