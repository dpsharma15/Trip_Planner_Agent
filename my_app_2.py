...
def sidebar_info():
    with st.sidebar:
        ...
        st.markdown("Enter your travel details below, and our AI-powered travel assistant will create a personalized itinerary including:")
        st.markdown("- **Best places to visit** 🎡")  
        st.markdown("- **Accommodation & budget planning** 💰")  
        st.markdown("- **Local food recommendations** 🍕")  
        st.markdown("- **Transportation & visa details** 🚆")  
...
def generate_travel_plan(from_city, destination_city, date_from, date_to, interests):
...
def main():
    app_title()
    sidebar_info()
    from_city, destination_city, date_from, date_to, interests = user_inputs()
    
    if st.button("🚀 Generate Travel Plan"):
        generate_travel_plan(from_city, destination_city, date_from, date_to, interests)
